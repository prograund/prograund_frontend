        ...
        <div className="chat d-flex justify-content-between p-2 align-items-center m-4" style={{ backgroundColor: "var(--color-2)",borderRadius:'5px' }}>
          <div className="d-flex ">
            ...
            <div className="ml-2 chat-text d-flex flex-column justify-content-center">
              ...
              <p style={{fontSize:'13px'}}>Lorem ipsum dolor...</p>
            </div>
          </div>
          <div className="">
            <Link className='btn mr-2' style={{ color: "var(--color-1)", backgroundColor: "var(--color-4)", letterSpacing: "1px", fontWeight: "900!important", border: "none", outline: "none", borderRadius: "5px", padding: "8px", }} to="/my-profile"><b>Profile</b></Link>
          </div>
        </div>
