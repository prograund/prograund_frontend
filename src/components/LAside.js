    ...
    <>
         <div className="aside fixed-left fixed l-0 col-md-3">
            <nav className="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
                <button className="navbar-toggler tog-butn mt-5 position-absolute d-md-none collapsed" type="button" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="rgb(117, 79, 229)" className="bi bi-list" viewBox="0 0 16 16">
            ...
            <nav id="sidebarMenu" className="col-md-9 m-auto d-md-block bg-light sidebar collapse">
                <div className="sidebar-sticky">
                    <ul className="nav nav-div flex-column">
                        ...
                        <li className="nav-item my-2">
                            <Link className="nav-link active" to="/host">
                        ...
                        <li className="nav-item my-2">
                            <Link className="nav-link active" to="/configuration">
                        ...
                        <li className="nav-item my-2">
                            <Link className="nav-link active" to="/tracks">
                        ...
                        <li className="nav-item my-2">
                            <Link className="nav-link active" to="/tech-support">
